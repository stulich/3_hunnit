...
class LibraryEvent(models.Model):
    # A character field for the event title
    event_Title = models.CharField(max_length=100)

    #a date and time field for date and time of event
    date_and_time= models.DateField(null=True, blank=True)

    # A character field for loaction
    event_Location = models.CharField(max_length=100)

    # A date field for what book is being talked about
    book_To_Discuss = models.CharField(max_length=100)
